...
export default function QueriesPage() {
  ...
  return (
    <div className="space-y-6 print:space-y-0 print:m-0 animate-fade-in pb-12">
      <PrintHeader />
      ...
      <div className="flex justify-between items-center print:hidden">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Filtre a base de dados e gere relatórios em PDF.
          </p>
        </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="alunos" className="m-0 border-none print:block">
          <Card className="print:shadow-none print:border-none print:bg-transparent">
            <CardHeader className="bg-primary/5 pb-4 border-b border-primary/10 print:hidden">
              ...
              <div className="overflow-x-auto print:overflow-visible">
                <Table>
                  <TableHeader className="bg-muted/50 print:bg-transparent print:border-b-2 print:border-black">
                    <TableRow>
                      <TableHead className="print:text-black font-bold">Matrícula</TableHead>
                      <TableHead className="print:text-black font-bold">Nome do Aluno</TableHead>
                      <TableHead className="print:text-black font-bold">Série/Ano</TableHead>
                      <TableHead className="print:text-black font-bold">Turma</TableHead>
                      <TableHead className="print:text-black font-bold">Situação</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {filteredStudents.map((s) => (
                      <TableRow key={s.id} className="print:border-b print:border-black/20">
                        ...
                        <TableCell className="print:text-black">{s.grade}</TableCell>
                        <TableCell className="print:text-black">{s.class}</TableCell>
                        <TableCell className="print:text-black">{s.status}</TableCell>
                      </TableRow>
                    ))}
